...
public class Vision extends Subsystem {
	...
	public PixyCamera gearPixy;
	public PixyCamera boilerPixy;
	...
	public Vision() {
		gearPixy = new PixyCamera("gear", new I2C(port, 0x54), packet1, new PixyException(print), new PixyPacket());
		boilerPixy = new PixyCamera("boiler", new I2C(port, 0x55), packet2, new PixyException(print), new PixyPacket());
	}
